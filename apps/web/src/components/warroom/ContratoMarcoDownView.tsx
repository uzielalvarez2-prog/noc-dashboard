...
import { Siren, Flag, X, RotateCw, Search, Check, Pencil } from "lucide-react";
        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            ...
            {!isLoading && down.length === 0 && (
              <tr><td colSpan={11} className="px-4 py-8 text-center text-sm text-text-muted">Sin incidentes de Contrato Marco caídos.</td></tr>
            )}
